...
export const variationImageSchema = yup.object({
  variation_id: yup
    .number()
    .typeError("المتغير يجب أن يكون رقمًا")
    .required("المتغير مطلوب")
    .integer("يجب أن يكون رقمًا صحيحًا"),
