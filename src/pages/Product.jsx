...
ChildAttributeFormSync.propTypes = {
  ...
  originalGroupData: PropTypes.shape({
    items: PropTypes.arrayOf(
      PropTypes.shape({
        id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
        sku: PropTypes.string,
        base_price: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
        base_buy_price: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
        quantity: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
        characteristics: PropTypes.any,
        special_attributes: PropTypes.arrayOf(
          PropTypes.shape({
            attribute_id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
